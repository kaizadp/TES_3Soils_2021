...
# FTICR Soil -- figures 
## native SOM
```{r soil_vk_baseline, echo=FALSE, warning=FALSE,message=FALSE,fig.cap="Van Krevelen plot for TZSat pores",fig.width=12, fig.height=5}
...
## treatment effect -- all peaks
```{r soil_vk_treatments, echo=FALSE, warning=FALSE,message=FALSE,fig.cap="Van Krevelen plot for treatments",fig.width=12, fig.height=5}
soil_hcoc %>% 
...
## treatment effect -- unique peaks
```{r soil_vk_unique, echo=FALSE, warning=FALSE,message=FALSE,fig.cap="Van Krevelen plot for uniqiue peaks",fig.width=12, fig.height=5}
# set level of factors
soil_unique %>% 
  mutate(unique = factor(unique, levels = c("field_moist","drought","saturation")))->
           soil_unique
...
## treatment effect -- relative abundance
```{r soiL_rel_abund, echo=FALSE, warning=FALSE,message=FALSE,fig.cap="Relative abundance",fig.width=9, fig.height=7}
# use file fticr_pore_relabundance_summary
# first, remove the `total` row
...
## NOSC
```{r soil_NOSC_c, echo=FALSE, fig.cap="NOSC for CPCRW", fig.height=6, fig.width=11, message=FALSE, warning=FALSE}
soil_nosc %>% 
  mutate(treatment = factor(treatment,
                            levels = c("baseline","time zero saturation", "field moist","drought","saturation")))->
  soil_nosc
...
## aromatic peaks
```{r soil_aromatic, echo=FALSE, warning=FALSE,message=FALSE,fig.cap="aromatic peaks", fig.width=12, fig.height=7}
soil_aromatic %>% 
  mutate(treatment = factor(treatment,
                            levels = c("baseline","time zero saturation", "field moist","saturation","drought")))->
  soil_aromatic
