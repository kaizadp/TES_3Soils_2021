...
#input files
aromatic = read.csv(FTICR_PORE_AROMATIC)
...
print(gg_pore_aromaticpeaks, base_width = 12, base_height = 7)
...
ggplot(FTICR_PORE_HCOC[FTICR_PORE_HCOC$treatment=="time zero saturation",],
...
ggplot(fticr_pore_hcoc2[!fticr_pore_hcoc2$treatment=="time zero saturation",], # remove baseline 
