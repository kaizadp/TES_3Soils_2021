...
pore_long %>% 
  dplyr::mutate(treatment = factor(treatment, 
                                   levels = c("time zero saturation","drought","field moist","saturation")))->
           pore_long
...
pore_unique %>% 
  dplyr::mutate(unique = factor(unique, levels = c("drought","field moist","saturation")))->
           pore_unique
