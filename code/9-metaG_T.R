...
betadisp=betadisper(e_distance, g_sample$Treatment,type = "centroid")

anova(betadisp)
TukeyHSD(betadisp)

#############
###MetaT distance boxplot to test if drought has significantly lower intra-treatment beta-diversity distance
#############
...
res_bld = results(dds_bld, contrast=c("Treatment","Drought","Base_Line"))
head(res_bld)
resultsNames(dds_bld)

#write.table(res_bld,file="treatment_and_site_log2fold_0.001_bld.txt",sep="\t")
...
#########heatmap based on DESEQ2 log2fold change
...
g_sample_bld$Site = revalue(g_sample_bld$Site, c("CPCRW"="Alaska","DWP"="Florida","SR"="Washington"))
g_sample_bld$Treatment = revalue(g_sample_bld$Treatment, c("Base_Line"="base line","Drought"="drought"))
...
####Heatmap focused on sporulation, motility, and osmoprotectant

lefse_combined_bld = c("TIGR02907","TIGR01925","TIGR02844","TIGR02836","TIGR02886","TIGR02851","TIGR02875","TIGR02214","TIGR02403",
                       "TIGR01804","TIGR03824","TIGR03818","TIGR02550","TIGR03522","TIGR01420","TIGR03530","TIGR03525","TIGR03529",
                       "TIGR03517","TIGR03513")
...
pheatmap(assay(ntd_bld)[lefse_combined_bld,],cluster_cols=FALSE,cluster_rows=FALSE,annotation_col = g_sample_bld,show_colnames=FALSE,color=cividis(99),
         annotation_colors=kd_3soil_colors,cellwidth=11,cellheight=11,gaps_row=13,
         labels_row = c("TIGR02907 spoVID Sporulation","TIGR01925 spoIIAB Sporulation","TIGR02844 spoIIID Sporulation","TIGR02836 spoIVA Sporulation","TIGR02886 spoIIAA Sporulation","TIGR02851 spoVT Sporulation","TIGR02875 spoOA Sporulation","TIGR02214 spoVD Sporulation","TIGR02403 treC Trehalose Synthesis",
                        "TIGR01804 betB Betaine Synthesis","TIGR03824 flgM Flagellar Motility","TIGR03818 motA Flagellar Motility","TIGR02550 flgL Flagellar Motility","TIGR03522 gldA Gliding Motility","TIGR01420 pilT Gliding Motility","TIGR03530 glJ Gliding Motility","TIGR03525 gldK Gliding Motility","TIGR03529 gldK-short Gliding Motility",
                        "TIGR03517 gldM Gliding Motility","TIGR03513 gldL Gliding Motility"))
...
g_sample$Site = revalue(g_sample$Site, c("CPCRW"="Alaska","DWP"="Florida","SR"="Washington"))
g_sample$Treatment = revalue(g_sample$Treatment, c("Base_Line"="base line","Drought"="drought","Sat_II"="flood","Sat_I"="time zero saturation","Field_Moist"="field moist"))
...
g_sample$Site = revalue(g_sample$Site, c("CPCRW"="Alaska","DWP"="Florida","SR"="Washington"))
g_sample$Treatment = revalue(g_sample$Treatment, c("Drought"="drought","Sat_II"="flood","Sat_I"="time zero saturation","Field_Moist"="field moist"))
...
#write.table(res_blsat2,file="treatment_and_site_log2fold_0.001_blsat2_DWP.txt",sep="\t")
...
g_sample_blsat2$Site = revalue(g_sample_blsat2$Site, c("CPCRW"="Alaska","DWP"="Florida","SR"="Washington"))
g_sample_blsat2$Treatment = revalue(g_sample_blsat2$Treatment, c("Base_Line"="base line","Sat_II"="flood"))
...
pheatmap(assay(ntd_blsat2)[site_combined_blsat2,],cluster_cols=FALSE,cluster_rows=FALSE,annotation_col = g_sample_blsat2,show_colnames=FALSE,color=cividis(99),
         annotation_colors=kd_3soil_colors,
...
site_combined_blsat2=c("TIGR02844","TIGR02851","TIGR02836","TIGR02846","TIGR02835","TIGR01395","TIGR02875")

site_combined_blsat2=c("TIGR02844","TIGR02851","TIGR02836","TIGR02875","TIGR02846","TIGR02835","TIGR01395")
...
pheatmap(assay(ntd_blsat2)[site_combined_blsat2,],cluster_cols=FALSE,cluster_rows=FALSE,annotation_col = g_sample_blsat2,show_colnames=FALSE,color=cividis(99),
         annotation_colors=kd_3soil_colors,cellwidth=11,cellheight=11,
         labels_row = c("TIGR02844 spoIIID Sporulation","TIGR02851 spoVT Sporulation","TIGR02836 spoIVA Sporulation","TIGR02875 spoOA Sporulation","TIGR02846 sigK Sporulation Transcription",
                        "TIGR02835 sigE Sporulation Transcription","TIGR01395 flgC Flagellar Motility"))



###########
###########Base Line-Drought, Washington only
###########
rm(list=ls())
...
#write.table(res_bld,file="treatment_and_site_log2fold_0.001_bld_SR.txt",sep="\t")
...
g_sample_bld$Site = revalue(g_sample_bld$Site, c("SR"="Washington"))
g_sample_bld$Treatment = revalue(g_sample_bld$Treatment, c("Base_Line"="base line","Drought"="drought"))
...
lefse_combined_bld = c("TIGR02907","TIGR01925","TIGR02844","TIGR02836","TIGR02886","TIGR03824","TIGR02851","TIGR02875","TIGR03818",
                       "TIGR02214","TIGR02550","TIGR02403","TIGR01804","TIGR03522","TIGR01420","TIGR03530","TIGR03525","TIGR03529",
                       "TIGR03517","TIGR03513")
...
pheatmap(assay(ntd_bld)[lefse_combined_bld,],cluster_cols=FALSE,cluster_rows=FALSE,annotation_col = g_sample_bld,show_colnames=FALSE,color=cividis(99),
         annotation_colors=kd_3soil_colors,cellwidth=12,cellheight=12,
         labels_row = c("TIGR02907 spoVID Sporulation","TIGR01925 spoIIAB Sporulation","TIGR02844 spoIIID Sporulation","TIGR02836 spoIVA Sporulation",
                        "TIGR02886 spoIIAA Sporulation","TIGR03824 flgM Flagellar Motility","TIGR02851 spoVT Sporulation","TIGR02875 spoOA Sporulation",
                        "TIGR03818 motA Flagellar Motility", "TIGR02214 spoVD Sporulation","TIGR02550 flgL Flagellar motility",
                        "TIGR02403 treC Trehalose Synthesis","TIGR01804 betB Betaine Synthesis","TIGR03522 gldA Gliding Motility","TIGR01420 pilT Gliding Motility",
                        "TIGR03530 glJ Gliding Motility","TIGR03525 gldK Gliding Motility","TIGR03529 gldK-short Gliding Motility","TIGR03517 gldM Gliding Motility",
                        "TIGR03513 gldL Gliding Motility"))


###########
###########Base Line-Drought, Alaska Only
###########
rm(list=ls())
...
g_sample_bld$Site = revalue(g_sample_bld$Site, c("CPCRW"="Alaska"))
g_sample_bld$Treatment = revalue(g_sample_bld$Treatment, c("Base_Line"="base line","Drought"="drought"))
...
###########
###########Base Line-Drought, Florida only
###########
rm(list=ls())
...
g_sample_bld$Site = revalue(g_sample_bld$Site, c("DWP"="Florida"))
g_sample_bld$Treatment = revalue(g_sample_bld$Treatment, c("Base_Line"="base line","Drought"="drought"))
